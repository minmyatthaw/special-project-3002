					...
					<div className="">
						<div className="mt-2 flex justify-between flex-wrap items-center gap-3 text-sm">
							<h1 className="text-2xl font-bold ">
								Campus Facility Damage Reporting System
							</h1>
						</div>
						<div className="flex items-center mt-1 gap-x-3">
							...
							<span className="flex items-center gap-1.5">
								...
								Submitted on 12-2-2026
							</span>
						</div>
						<div className="mt-5 space-y-1">
							<p className="text-lg font-semibold">Project Description</p>
							<p className="text-muted-foreground">
								A web-based platform where students and staff can report campus
								infrastructure damage with photos, location, and severity level.
								Administrators can track, prioritize, and update repair status
								through an analytics dashboard.
							</p>
						</div>
					</div>
					<div className="dark:bg-primary-700 min-w-[250px] bg-primary-100 rounded-lg p-8 relative overflow-hidden">
